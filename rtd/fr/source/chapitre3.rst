...
atoum est capable de vous prévenir lorsque les tests sont exécutés en utilisant plusieurs système de notification : :ref:`Growl <growl>`, :ref:`Notification Center <osxnotificationcenter>`, :ref:`Libnotify <libnotify>`.
